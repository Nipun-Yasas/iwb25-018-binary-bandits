                  ...
                  <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                    ...
                    >
                      ...
                      >
                        $
                        {(
                          stats.financial.totalCoverageAmount / 1000000
                        ).toFixed(1)}
                        M
                      </Typography>
                      <Typography
                  ...
                  <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                    <Box
                      ...
                      sx={{
                        ...
                        borderRadius: 3,
                        background:
                          "linear-gradient(135deg, rgba(237, 108, 2, 0.1) 0%, rgba(255, 152, 0, 0.1) 100%)",
                  ...
                  <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                    <Box
                      ...
                      sx={{
                        ...
                        borderRadius: 3,
                        background:
                          "linear-gradient(135deg, rgba(2, 136, 209, 0.1) 0%, rgba(3, 169, 244, 0.1) 100%)",
