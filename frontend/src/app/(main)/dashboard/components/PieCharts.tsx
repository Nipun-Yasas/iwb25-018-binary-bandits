...
export const ClaimStatusPieChart: React.FC<ClaimStatusPieChartProps> = ({
  data,
}) => {
  ...
  return <SimplePieChart data={chartData} title="Claim Status Distribution" />;
};
...
export const ProviderTypePieChart: React.FC<ProviderTypePieChartProps> = ({
  data,
}) => {
  const chartData: PieChartData[] = [
  ...
  return <SimplePieChart data={chartData} title="Provider Type Distribution" />;
};
...
export const PatientGenderPieChart: React.FC<PatientGenderPieChartProps> = ({
  data,
}) => {
  const chartData: PieChartData[] = [
  ...
  return (
    <SimplePieChart data={chartData} title="Patient Gender Distribution" />
  );
};
